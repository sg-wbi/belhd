...
from models.utils import run_ab3p, save_json
...
class Model(metaclass=ABCMeta):
    ...
    def clean_abbreviation_dictionary(self, abbreviations: dict) -> dict:
    ...
    def build_abbreviation_dictionary(self, examples: list[Example]) -> dict:
        ...
        abbreviations = self.clean_abbreviation_dictionary(abbreviations)
